        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-12 p-2 md:p-12">
            <div className="col-span-6 md:order-1 order-2">
              <h3 className="text-[#393E50] lg:text-[40px] text-[20px] font-nunito font-extrabold lg:leading-[48px] leading-[28px] lg:mb-[20px] mb-[26px]">
                Why should Your Use Our Services?
              </h3>
              <p className="text-[#747474] text-[16px] font-nunito font-semibold leading-[20px] mb-[40px]">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-10 flex-wrap">
                <div className="flex flex-col justify-center items-center">
                  ...
                  <p className="text-[ #393E50] font-nunito font-semibold text-[16px] leading-[20px] opacity-[.4]">
                    Country Touched
                  </p>
                </div>
