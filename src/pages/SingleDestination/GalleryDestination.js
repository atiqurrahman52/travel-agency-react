    ...
    <div>
      <div className="mt-5 lg:mt-9">
        ...
        <div className="grid lg:grid-flow-col lg:grid-rows-2 grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-2">
          <div className="group rounded-[10px] overflow-hidden cursor-pointer lg:row-span-2">
            <img src={image_1} className="w-full h-full" alt="" />
          </div>

          <div className="group rounded-[10px] overflow-hidden cursor-pointer">
            <img src={image_2} className="w-full h-full" alt="" />
          </div>

          <div className="group rounded-[10px] overflow-hidden cursor-pointer">
            <img src={image_3} className="w-full h-full" alt="" />
          </div>
