...
const IncredibleTurkey = () => {
    return (
        <div>
            <div className="mb-10">
                <h3
                  className="text-[#393E50] font-nunito font-extrabold lg:text-[40px] text-[20px] lg:leading-[48px] leading-[28px] mb-4"
                >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <p
                      className="text-[#393E50] lg:text-[16px] text-[14px] font-nunito font-semibold leading-[20px]"
                    >
                      Turkey
                    </p>
                  </div>
                  <div>
                    <p
                      className="text-[#D00338E5] lg:text-[32px] text-[16px] font-nunito font-extrabold lg:leading-[40px] leading-[22px]"
                    >
                      $56780000
                    </p>
                  </div>
            ...
            
                 {
                  ...
                  >
                    ...
                    <div className="text-center md:text-left space-y-3">
                      <h3
                        className="text-[#393E50] text-[16px] font-nunito font-extrabold leading-[20px]"
                      >
                        {item.title}
                      </h3>
                      <p
                        className="text-[#747474] lg:text-[16px] text-[14px] font-nunito font-semibold lg:leading-[20px] leading-[16px]"
                      >
                       {item.details}
                      </p>
                    </div>
