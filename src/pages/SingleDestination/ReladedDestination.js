        ...
        >
          ...
          >
            <div className="flex items-start justify-between flex-col h-full">
              <div
                className="lg:flex flex-col justify-center text-white font-nunito font-extrabold text-[16px] leading-[20px] gap-3"
              >
              ...
              <div>
                <div
                  className="flex items-center justify-start gap-2 text-white font-nunito font-semibold text-[14px] leading-[16px]"
                >
