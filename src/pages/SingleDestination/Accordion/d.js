    ...
    <div className="">
      <div className="container">
        ...
        <div className="flex md:justify-center justify-start items-center gap-[40px]  text-[#E46D8C]  overflow-x-auto">
          <button
            className="font-nunito font-extrabold text-[16px] leading-[20px] text-[#747474] cursor-pointer active"
            onClick={() => filterItem("europe")}
          >
            {" "}
            Europe
          </button>
          <button
            className="font-nunito font-extrabold text-[16px] leading-[20px] text-[#747474] cursor-pointer"
            onClick={() => filterItem("asia")}
          >
            {" "}
            Asia
          </button>
        ...
        <div className="flex justify-center mt-[40px] lg:mt-[80px] mb-[80px] lg:mb-[118px]">
          <Link
            className="flex w-10 h-10 mx-2 bg-[#F1B4C433] justify-center items-center rounded-lg border bg-white text-black"
            to="#"
            title="Previous Page"
          >
            <CaretLeft size={22} />
          ...
          <Link
            className="flex w-10 h-10 mx-2 justify-center items-center rounded-lg border border-gray-200 bg-[#F1B4C4] font-bold text-[16px] leading-[20px] text-[#D00338E5]"
            to="#"
            title="Page 1"
          >
            1
          ...
          <Link
            className="flex w-10 h-10 mx-2 justify-center items-center rounded-lg border text-[#D00338E5] bg-white font-bold"
            to="#"
            title="Page 2"
          >
            2
          ...
          <Link
            className="flex w-10 h-10 mx-2 justify-center items-center rounded-lg border bg-white font-bold text-[#D00338E5]"
            to="#"
            title="Page 3"
          >
            3
          ...
          <Link
            className="flex w-10 h-10 ml-1 justify-center items-center rounded-lg border bg-[#D00338E5] text-white"
            to="#"
            title="Next Page"
          >
            <CaretRight size={22} />
