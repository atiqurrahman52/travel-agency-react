  ...
  return (
    <div className="">
      <div className="container">
        <h3 class="text-[#393E50]  font-nunito font-extrabold lg:text-[32px] text-[16px] lg:leading-[40px] leading-[22px] text-center mb-[32px]">
          ...
          {items.map(({ id, country, details, days, price, img }) => (
            <div key={id} className="">
              ...
              >
                ...
                <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#00000000]/0 to-[#00000000]/100 p-4 lg:p-11">
                  <div class="flex items-start justify-between flex-col h-full">
                    <Link
                      to="/single-destination"
                      class="flex items-center justify-center gap-2"
                    >
                      <span class="w-[10px] h-[10px] rounded-full bg-[#F30D60] inline-block"></span>
                      <p class="font-nunito font-extrabold lg:text-[16px] text-[14px] leading-[20px] text-[#FFFFFF]">
                        {country}
                      </p>
                    </Link>
                    <div>
                      <div class="mb-3">
                        <Link to="/single-destination">
                          <p class="text-[#FFFFFF] lg:text-[24px] text-[16px] font-nunito font-extrabold lg:leading-[30px] leading-[22px]">
                            {details}
                          </p>
                        </Link>
                      </div>
                      <div class="flex items-center justify-start gap-2">
                        <p class="font-nunito font-extrabold text-[#FFFFFF]/60 text-[16px] leading-[20px]">
                          {days}
                        </p>
                        <p class="font-nunito font-extrabold text-[#FFFFFF] text-[16px] leading-[20px]">
                          {price}
                        </p>
                      </div>
                    </div>
